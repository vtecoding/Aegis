...
if TYPE_CHECKING:
    ...
    from aegis.contracts.trust_policy_config import TrustPolicyConfigValidationResult
...
def _is_certified_verifier(
    ...
    if result is None:
        return False
    from aegis.contracts.attestation_verifier import VerifierCertificationStatus
...
def _is_valid_trust_policy_config(
    ...
    if result is None:
        return False
    from aegis.contracts.trust_policy_config import TrustPolicyConfigStatus
