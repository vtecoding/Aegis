...
ADAPTER_AUTHORITY_CONTRACTS = (
    ...
    adapter_manifest_for(
        contract_type=ApprovalLedgerPersistenceRecord,
        authoritative_fields=(
            "contract_version",
            "repository_id",
            "ledger_epoch",
        ...
        checksum_function="approval_ledger_persistence_record_checksum",
        reason="persistence records bind canonical detached repository state payload for ADR-0028",
    ),
    adapter_manifest_for(
        contract_type=ApprovalLedgerPersistenceReceipt,
        authoritative_fields=(
            "status",
            "reason",
            "contract_version",
        ...
        checksum_function="approval_ledger_persistence_receipt_checksum",
        reason=(
            "persistence receipts bind deterministic write outcomes without authority escalation"
        ),
    ),
    adapter_manifest_for(
        contract_type=ApprovalLedgerPersistenceLoadResult,
        authoritative_fields=(
            "status",
            "reason",
            "contract_version",
        ...
        checksum_function="approval_ledger_persistence_load_result_checksum",
        reason="load results bind persisted payload bytes and deterministic load status",
    ),
    adapter_manifest_for(
        contract_type=ApprovalLedgerPersistenceValidationResult,
        authoritative_fields=(
            "status",
            "reason",
            "contract_version",
        ...
        checksum_function="approval_ledger_persistence_validation_result_checksum",
        reason="validation results bind fail-closed persistence authority checks",
    ),
    adapter_manifest_for(
        contract_type=ApprovalLedgerRecoveryResult,
        authoritative_fields=(
            "status",
            "reason",
            "contract_version",
        ...
        checksum_function="approval_ledger_recovery_result_checksum",
        reason="recovery results bind reconstructed detached state evidence after validation",
    ),
    adapter_manifest_for(
        contract_type=ApprovalLedgerPersistenceAdapterDescriptor,
        authoritative_fields=(
            "adapter_id",
            "adapter_kind",
        ...
        checksum_function="approval_ledger_persistence_adapter_descriptor_checksum",
        reason="adapter descriptors declare capability without claiming production durability",
    ),
)
