...
def _capability_lease_scenarios() -> tuple[ScenarioDefinition, ...]:
    return tuple(
        _adapter_replay_category_scenario(category)
        for category in (
            ScenarioCategory.CAPABILITY_LEASE_NULL_POSITIVE,
            ScenarioCategory.CAPABILITY_LEASE_REQUIRES_ADMISSION,
            ScenarioCategory.CAPABILITY_LEASE_SCOPE_SUBSET,
            ScenarioCategory.CAPABILITY_LEASE_REGISTRY_DRIFT,
            ScenarioCategory.CAPABILITY_LEASE_MANIFEST_DRIFT,
            ScenarioCategory.CAPABILITY_LEASE_CERTIFICATION_DRIFT,
            ScenarioCategory.CAPABILITY_LEASE_REPLAY_DRIFT,
