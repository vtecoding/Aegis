...
from aegis.contracts.policy import Capability, Policy, WorldSnapshotStub
from aegis.contracts.world_snapshot_freshness import FreshnessPolicy
...
class ScenarioCategory(StrEnum):
    """Required ADR-0013 scenario categories."""
...
"""Minimum ADR-0013 category matrix required by the coverage gate."""
