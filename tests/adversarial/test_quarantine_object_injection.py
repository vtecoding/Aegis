...
import pytest
from tests.command_quarantine_fixtures import command_quarantine_parts, operator_approval_receipt
...
def test_callable_scope_injection_blocks_release() -> None:
    (
        ...
        context_authority,
        capability_lease,
    ) = command_quarantine_parts(request_id="quarantine-object-release")
    ...
    object.__setattr__(approval, "approved_scope", frozenset({lambda: "scope"}))
